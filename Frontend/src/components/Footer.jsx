  ...
  return (
    <footer className="bg-black text-white px-20 py-10 mt-16">
      <div className="mb-6">
        ...
        <p className="text-gray-400">Premium watches delivered worldwide.</p>
      </div>
      ...
      <div className="mb-6">
        ...
        <ul className="list-none flex gap-5 p-0">
          ...
          <li><Link to="/shop" className="text-gray-300 hover:text-primary transition">Shop</Link></li>
          <li><Link to="/about" className="text-gray-300 hover:text-primary transition">About</Link></li>
